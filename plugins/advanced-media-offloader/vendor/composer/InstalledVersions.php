 ...
 */
namespace WPFitter\Composer;

use WPFitter\Composer\Autoload\ClassLoader;
use WPFitter\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    public static function getInstalledPackages()
    {
        ...
        return \array_keys(\array_flip(\call_user_func_array('WPFitter\\array_merge', $packages)));
    }
    /**
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('WPFitter\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
