...
namespace WPFitter\Aws\EndpointV2;

use WPFitter\Aws\Api\Operation;
use WPFitter\Aws\Api\Service;
use WPFitter\Aws\Auth\Exception\UnresolvedAuthSchemeException;
use WPFitter\Aws\CommandInterface;
use Closure;
use WPFitter\GuzzleHttp\Promise\Promise;
use function WPFitter\JmesPath\search;
/**
