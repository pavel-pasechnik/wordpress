...
/**
 * Title: Footer
 * Slug: krishna-consciousness-academy/footer
 * Categories: footer
...
<div class="wp-block-group footer-container"><!-- wp:group {"className":"footer-address-container"} -->
	<div class="wp-block-group footer-address-container"><!-- wp:paragraph {"className":"footer-address"} -->
		<p class="footer-address">
			<a class="footer-link" href="https://maps.app.goo.gl/7iRstgRygdGF47E67" target="_blank" rel="noopener">
				Зоряний провулок, 16, Київ
			</a>
		</p>
		<!-- /wp:paragraph -->
	</div>
	...
	<!-- wp:paragraph {"className":"footer-p"} -->
	<p class="footer-p">© 2025 Kyiv Krishna consciousness spiritual Academy. <br> All rights reserved.</p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->